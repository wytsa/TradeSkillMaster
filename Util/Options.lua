...
local function LoadOptionsPage(parent)
	local presetThemes = {
		...
		tsmdeck = {L["TSM Deck (by Jim Younkin - Power Word Gold)"], "frameColors{frameBG{backdrop{29,29,29,1}border{20,20,20,1}}content{backdrop{27,27,27,1}border{67,67,65,1}}frame{backdrop{39,39,40,1}border{20,20,20,1}}}textColors{iconRegion{enabled{216,216,224,1}}text{enabled{245,240,251,1}disabled{115,115,115,1}}title{enabled{247,248,255,1}}label{enabled{238,249,237,1}disabled{110,110,110,1}}}edgeSize{1}fontSizes{normal{14}small{12}}"},
	}
