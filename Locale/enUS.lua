...
L["Feature Highlight Color"] = true
L["Feature Text Color"] = true
L["Control Button Color"] = true
L["Control Highlight Color"] = true
L["Control Text Color"] = true
L["Action Button Color"] = true
L["Action Highlight Color"] = true
L["Action Text Color"] = true
L["Action2 Button Color"] = true
L["Action2 Highlight Color"] = true
L["Action2 Text Color"] = true
L["Main TSM Frame Colors"] = true
L["Use the options below to change the color of the various TSM frames including this frame as well as the Craft Management Window."] = true
