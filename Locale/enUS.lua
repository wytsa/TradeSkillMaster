...
L["Switch to 'Full' Mode"] = true
L["Switch to 'Lite' Mode"] = true
...
L["This button toggles TSM between 'Lite' and 'Full' modes. In 'Lite' mode, all features related to TSM groups are disabled. 'Lite' mode is recommended for beginners who want to use TSM but aren't yet ready to tackle TSM groups and operations."] = true
